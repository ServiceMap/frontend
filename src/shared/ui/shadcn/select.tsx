...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "tw:border-input tw:ring-offset-background tw:focus:ring-ring tw:data-[placeholder]:text-muted-foreground tw:flex tw:h-9 tw:w-full tw:items-center tw:justify-between tw:rounded-md tw:border tw:bg-transparent tw:px-3 tw:py-2 tw:text-sm tw:whitespace-nowrap tw:shadow-sm tw:focus:ring-1 tw:focus:outline-none tw:disabled:cursor-not-allowed tw:disabled:opacity-50 tw:[&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "tw:focus:bg-accent tw:focus:text-accent-foreground tw:relative tw:flex tw:w-full tw:cursor-default tw:items-center tw:rounded-sm tw:py-1.5 tw:pr-8 tw:pl-2 tw:text-sm tw:outline-none tw:select-none tw:data-[disabled]:pointer-events-none tw:data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
